...
RSpec.describe Terradoc::Analyzer::DependencyAnalyzer do
  ...
  def build_project(root_path, name:, shared: false)
    ...
    project = Terradoc::Model::Project.new(name: name, path: root_path, parsed_files: parsed_files, shared: shared)

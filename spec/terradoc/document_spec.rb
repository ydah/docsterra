...
RSpec.describe Terradoc::Document do
  it "saves markdown to a file and exposes summary" do
    config = Terradoc::Config.new(output_path: "./tmp.md")
    project = Terradoc::Model::Project.new(name: "p", path: ".", parsed_files: {})
    project.resources = [
      Terradoc::Model::Resource.new(type: "google_compute_network", name: "vpc", attributes: {}, project: project)
    ]

...
RSpec.describe Docsterra::Analyzer::SecurityAnalyzer do
  ...
  def load_resources(*relative_files)
    ...
    project = Docsterra::Model::Project.new(name: "test", path: File.dirname(files.first), parsed_files: parsed_files)
